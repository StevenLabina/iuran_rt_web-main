...
import 'package:iuran_rt_web/screens/buat_kk_pemilik.dart';
import 'package:iuran_rt_web/screens/pdf_kk_pemilik.dart';
import 'package:iuran_rt_web/screens/ubah_kk_pemilik_rumah.dart';
import 'package:iuran_rt_web/url.dart';

class KkPemilikRumahPage extends StatefulWidget {
  final String no_kk;

  KkPemilikRumahPage({required this.no_kk});
  @override
  _KkPemilikRumahPageState createState() => _KkPemilikRumahPageState();
}

class _KkPemilikRumahPageState extends State<KkPemilikRumahPage> {
  ...
  Future<void> fetchKkData() async {
    ...
    final response = await http.post(
      Uri.parse('${ApiUrls.baseUrl}list_kk_pemilik.php'),
      headers: {
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => buatKkPemilikRumahPage(no_kk: widget.no_kk.toString()),
                  ),
                );
              },
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                 Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => BuatWargaPagePdf(no_kk: widget.no_kk.toString()),
                  ),
                );
              },
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  ubahKkPemilikRumahPage(id: parsedId),
                            ),
                          );
                        },
