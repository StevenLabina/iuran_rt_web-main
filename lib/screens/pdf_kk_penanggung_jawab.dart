...
class BuatWargaPagePdfPenanggung extends StatefulWidget {
  final String no_kk;

  BuatWargaPagePdfPenanggung({required this.no_kk});

  @override
  _BuatWargaPagePdfPenanggungState createState() =>
      _BuatWargaPagePdfPenanggungState();
}

class _BuatWargaPagePdfPenanggungState
    extends State<BuatWargaPagePdfPenanggung> {
  String fileName = '';
  File? selectedFile;
  ...
  Future<void> uploadPdfToServer() async {
    ...
    try {
      final uri = Uri.parse('${ApiUrls.baseUrl}/savePathPenanggung.php');
  ...
  Future<void> fetchPdfPathPenanggung() async {
    try {
      final response = await http.get(
        Uri.parse(
            '${ApiUrls.baseUrl}/getPdfPathPenanggung.php?no_kk=${widget.no_kk}'),
      );
