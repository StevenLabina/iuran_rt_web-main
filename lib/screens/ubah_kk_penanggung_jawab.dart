...
class ubahKkPenanggungJawabPage extends StatefulWidget {
  final int id;

  ubahKkPenanggungJawabPage({required this.id});

  @override
  _ubahKkPenanggungJawabPageState createState() =>
      _ubahKkPenanggungJawabPageState();
}

class _ubahKkPenanggungJawabPageState extends State<ubahKkPenanggungJawabPage> {
  ...
  Future<void> fetchWargaData() async {
    try {
      final response = await http.get(
          Uri.parse("${ApiUrls.baseUrl}/getKkPenanggung.php?id=${widget.id}"));
  ...
  Future<void> updateWargaData() async {
    try {
      final response = await http.post(
        Uri.parse("${ApiUrls.baseUrl}/updateKkPenanggungJawab.php"),
        body: {
