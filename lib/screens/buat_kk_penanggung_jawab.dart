...
class buatKkPenanggungJawabPage extends StatefulWidget {
  final String no_kk;

  buatKkPenanggungJawabPage({required this.no_kk});

  @override
  _buatKkPenanggungJawabPageState createState() =>
      _buatKkPenanggungJawabPageState();
}

class _buatKkPenanggungJawabPageState extends State<buatKkPenanggungJawabPage> {
  ...
  Future<void> buatWargaData() async {
    try {
      final response = await http.post(
        Uri.parse("${ApiUrls.baseUrl}/buatKkPenanggungJawab.php"),
        body: {
